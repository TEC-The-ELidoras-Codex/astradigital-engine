...
def check_container_status(
        container_name: str = "tec_office") -> Dict[str, Any]:
    """
...
def run_tests_in_container(
        container_name: str = "tec_office",
        test_path: str = "tests/") -> str:
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Docker Management for TEC_OFFICE_REPO')
    subparsers = parser.add_subparsers(dest='command', help='Command to run')

    # Check command
    check_parser = subparsers.add_parser(
        'check', help='Check if Docker is installed')
    ...
    up_parser = subparsers.add_parser(
        'up', help='Start containers with docker-compose up')
    ...
    down_parser = subparsers.add_parser(
        'down', help='Stop containers with docker-compose down')
    ...
    test_parser = subparsers.add_parser(
        'test', help='Run tests in the container')
